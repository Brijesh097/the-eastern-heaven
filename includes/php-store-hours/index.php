...
<html lang="en" xml:lang="en"><head>
    ...
    $hours = array(
        'mon' => array('10:00-13:00', '17:00-22:00'),
        'tue' => array('10:00-13:00', '17:00-22:00'),
        'wed' => array('10:00-13:00', '17:00-22:00'),
        'thu' => array('10:00-13:00', '17:00-22:00'), // Open late
        'fri' => array('10:00-13:00', '17:00-22:00'),
        'sat' => array('10:00-23:00'),
        'sun' => array('10:00-23:00')
    );
    ...
    if($store_hours->is_open()) {
        echo "<h3>Yes, we're open! Today's hours are " . $store_hours->hours_today() . ".</h3>";
    } else {
        echo "<h5>Sorry, we're closed. Today's hours are " . $store_hours->hours_today() . ".</h5>";
    }
